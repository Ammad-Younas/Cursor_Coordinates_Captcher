...
def count_down():
    ...
    if keyboard.is_pressed('c'):
        ...
        x_copy_label = Label(text="Copied!", font=('Segoe Script', 10, "bold"), bg='#f0f0f0', fg='green')
        x_copy_label.place(x=45, y=120)
        y_copy_label = Label(text="Copied!", font=('Segoe Script', 10, "bold"), bg='#f0f0f0', fg='red')
        y_copy_label.place(x=210, y=120)
        ...
        x_copy_label = Label(text="Copied!", font=('Segoe Script', 10, "bold"), bg='#f0f0f0', fg='#f0f0f0')
        x_copy_label.place(x=45, y=120)
        y_copy_label = Label(text="Copied!", font=('Segoe Script', 10, "bold"), bg='#f0f0f0', fg='#f0f0f0')
        y_copy_label.place(x=210, y=120)
...
x_copy_label = Label(window, text="", font=('Segoe Script', 10, "bold"), fg='#f0f0f0', bg="#f0f0f0").place(x=45, y=120)
y_copy_label = Label(window, text="", font=('Segoe Script', 10, "bold"), fg='#f0f0f0', bg="#f0f0f0").place(x=210, y=120)
